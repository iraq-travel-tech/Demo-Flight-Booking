...
export default function FlightDetails({
  ...
  return (
    <div className="dark:bg-zinc-800 bg-zinc-300 py-3 px-4 md:px-7 md:w-max w-full rounded-xl relative flex gap-4 items-center justify-between md:mt-0 mt-[4em] self-end transition-all md:min-w-[32em]">
      <div className="h-[5em] md:hidden w-1 absolute bg-zinc-800 rounded-t-full -translate-x-[50%] left-[50%] -translate-y-[100%] top-0 flex items-center justify-center overflow-visible">
        <div className="bg-zinc-800 min-w-[2.5em] h-[2.5em] flex items-center justify-center rounded-full text-xs text-zinc-400">
          {FlightIndex + 1}
        </div>
      </div>

      <div className="md:block hidden absolute h-1 md:w-[2em]  bg-zinc-800 left-0 -translate-x-[100%] top-[50%] -translate-y-[50%]">
